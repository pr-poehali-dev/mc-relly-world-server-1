      ...
      <section id="donate" className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Card className="border-border bg-card hover:border-primary transition-all hover:scale-105">
              <CardHeader>
                <Icon name="Pickaxe" className="text-primary mb-2" size={32} />
                <CardTitle className="text-foreground">Базовый</CardTitle>
                <CardDescription className="text-muted-foreground">Для начинающих</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-foreground mb-4">100₽</div>
            ...
            <Card className="border-2 border-secondary bg-card relative hover:scale-105 transition-all">
              ...
              <CardHeader>
                <Icon name="Crown" className="text-secondary mb-2" size={32} />
                <CardTitle className="text-foreground">Премиум</CardTitle>
                <CardDescription className="text-muted-foreground">Для настоящих фанатов</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-foreground mb-4">300₽</div>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2">
            ...
            <Card className="border-border bg-card hover:border-accent transition-all hover:scale-105">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">VIP</CardTitle>
                <CardDescription className="text-muted-foreground">Максимум возможностей</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-foreground mb-4">500₽</div>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2">
